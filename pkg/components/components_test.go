...
func TestFcrepoDefinition(t *testing.T) {
	...
	assertDoesNotHaveRulePath(t, definition.On.Compose.Rules, ".services.fcrepo-database-init")
	assertDoesNotHaveRulePath(t, definition.On.Compose.Rules, ".services.fcrepo.depends_on.fcrepo-database-init")
	...
	assertDoesNotHaveRulePath(t, definition.On.Compose.Rules, ".services.fcrepo.environment.DB_BOOTSTRAP_ENABLED")
