...
func TestFcrepoDefinition(t *testing.T) {
	...
	assertHasRule(t, definition.On.Compose.Rules, OpDelete, ".services.fcrepo-database-init")
	assertHasRule(t, definition.On.Compose.Rules, OpDelete, ".services.fcrepo.depends_on.fcrepo-database-init")
